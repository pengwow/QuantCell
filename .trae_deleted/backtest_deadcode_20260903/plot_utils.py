...
def plot_results(results: dict[str, Any], output: str | None, show: bool, plot_type: str):
    """
    绘制回测结果图表
    ...
    for _i, symbol_key in enumerate(symbols):
...
def _plot_trade_distribution(symbol: str, trades: list[dict], metrics: dict, output: str | None, show: bool):
    """绘制交易分布图"""
    import matplotlib.pyplot as plt
...
def _plot_metrics_summary(symbol: str, metrics: dict, output: str | None, show: bool):
    """绘制指标汇总图"""
    import matplotlib.pyplot as plt
