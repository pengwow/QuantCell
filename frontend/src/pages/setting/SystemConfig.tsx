      ...
      <Card className="settings-panel" title="系统配置" variant="outlined">
        ...
        >
          ...
          <Card size="small" className="mb-4">
              ...
              <>
                ...
                <Form.Item
                  label={
                    <div className="flex items-center">
                      计价货币
                      <Tooltip title="选择默认的计价货币，用于交易对报价" placement="right">
                        <QuestionCircleOutlined className="ml-2 text-blue-500" />
                      </Tooltip>
                    </div>
                  }
                ...
                >
                  <Select
                    onChange={(value) => setSystemConfig(prev => ({ ...prev, quote: value }))}
                  >
            ...
            >
              <InputNumber
                onChange={(value) => setSystemConfig(prev => ({ ...prev, default_commission: value || 0 }))}
                min={0}
                max={1}
                step={0.0001}
                className="w-full"
            ...
            >
              <InputNumber
                onChange={(value) => setSystemConfig(prev => ({ ...prev, default_initial_cash: value || 1000000 }))}
                min={1000}
                max={100000000}
                step={1000}
                className="w-full"
          ...
          <Card size="small" className="mb-4">
            ...
            >
              <div className="flex items-center">
                ...
                />
                <Text className="ml-2">是否启动代理</Text>
              </div>
            </Form.Item>
          ...
          <Card size="small">
            ...
            >
              <div className="flex items-center">
                ...
                />
                <Text className="ml-2">是否启用实时引擎</Text>
              </div>
            </Form.Item>
          </Card>
        </Form>
