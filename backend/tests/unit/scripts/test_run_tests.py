...
class TestRunCommand:
    ...
    @patch("scripts.run_tests.subprocess.run")
...
class TestRunAllTests:
    ...
    @patch("scripts.run_tests.run_command")
...
class TestRunUnitTests:
    ...
    def test_run_unit_tests(self, mock_run_command):
        """测试运行单元测试"""
        from scripts.run_tests import run_unit_tests
...
class TestRunIntegrationTests:
    ...
    def test_run_integration_tests(self, mock_run_command):
        """测试运行集成测试"""
        from scripts.run_tests import run_integration_tests
...
class TestRunApiTests:
    ...
    def test_run_api_tests(self, mock_run_command):
        """测试运行API测试"""
        from scripts.run_tests import run_api_tests
...
class TestRunCoverageReport:
    ...
    def test_run_coverage_report(self, mock_run_command):
        """测试生成覆盖率报告"""
        from scripts.run_tests import run_coverage_report
...
class TestRunSpecificTest:
    ...
    def test_run_specific_test(self, mock_run_command):
        """测试运行特定测试文件"""
        from scripts.run_tests import run_specific_test
...
class TestMainCommand:
    ...
    @patch("scripts.run_tests.run_all_tests")
    def test_main_default(self, mock_run_all_tests):
        """测试默认运行所有测试"""
        from scripts.run_tests import app
    ...
    @patch("scripts.run_tests.run_unit_tests")
    ...
    @patch("scripts.run_tests.run_integration_tests")
    ...
    @patch("scripts.run_tests.run_api_tests")
    ...
    @patch("scripts.run_tests.run_coverage_report")
    ...
    @patch("scripts.run_tests.run_specific_test")
    ...
    @patch("scripts.run_tests.get_project_root")
