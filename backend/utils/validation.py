...
def validate_symbols(symbols: str | None) -> bool:
    """
    验证货币对格式
...
def validate_timeframes(timeframes: str | None) -> bool:
    """
    验证时间周期
...
def parse_timeframes(timeframes: str | None) -> list[str]:
    """
    解析时间周期字符串为列表
...
def validate_trading_mode(mode: str | None) -> bool:
    """
    验证交易模式
