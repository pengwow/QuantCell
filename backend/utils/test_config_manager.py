...
config_items = [
    ...
    {
        "key": "apiPermissions",
        "value": '[{"id":"read","name":"读取权限","description":"允许读取系统数据和配置","enabled":true},{"id":"write","name":"写入权限","description":"允许修改系统数据和配置","enabled":false},{"id":"execute","name":"执行权限","description":"允许执行系统操作和任务","enabled":true}]',
    ...
    },
    {
        ...
        "value": "true",
        "description": "test-plugin.test_plugin_enabled",
        "plugin": "test-plugin",
        "name": "测试插件设置",
    },
    {
        ...
        "value": "normal",
        "description": "test-plugin.test_plugin_mode",
        "plugin": "test-plugin",
        "name": "测试插件设置",
    },
    {
        ...
        "value": "30",
        "description": "test-plugin.test_plugin_timeout",
        "plugin": "test-plugin",
        "name": "测试插件设置",
    },
]
