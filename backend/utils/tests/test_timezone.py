...
class TestGetTimezone:
    ...
    def test_get_from_config(self):
        ...
        with (
            patch(
                "backend.utils.timezone._get_config_manager",
    ...
    def test_invalid_timezone_fallback(self):
        ...
        with (
            ...
            patch("backend.utils.timezone.logger") as mock_logger,
        ):
            tz = get_timezone()
            assert tz.zone == "Asia/Shanghai"
...
class TestToLocalTime:
    ...
    def test_naive_datetime(self):
        ...
        with patch(
            "backend.utils.timezone.get_timezone",
            return_value=pytz.timezone("Asia/Shanghai"),
        ):
