...
class ProjectInitializer:
    ...
    def _step_config_import(self, config_path: str | None = None, **kwargs) -> bool:
        """配置导入步骤"""
        if not config_path:
        ...
        try:
            stats = ConfigIO.import_from_toml(input_path=config_path, overwrite=True, dry_run=False)
