        ...
        def wrapper(*args, **kwargs):
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    sleep_time = e.retry_after if isinstance(e, RateLimitError) and e.retry_after else current_delay
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(self, *args, **kwargs):
            ...
            if not hasattr(self, "_exchange_features") or not self._exchange_features.get(feature, False):
                ...
                msg = f"Feature '{feature}' is not supported by {exchange_name}"
...
def require_connected[F: Callable[..., any]](func: F) -> F:
    """
    连接检查装饰器
    ...
    def wrapper(self, *args, **kwargs):
        if not getattr(self, "_connected", False):
            exchange_name = getattr(self, "exchange_name", "Unknown")
            msg = f"Exchange {exchange_name} is not connected. Call connect() first."
