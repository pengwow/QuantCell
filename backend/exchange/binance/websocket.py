...
from .exceptions import BinanceWebSocketError
...
class BinanceWebSocketManager:
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            raise BinanceWebSocketError(msg)
    ...
    async def subscribe_kline(self, symbol: str, interval: str = "1m") -> str:
        ...
        try:
            ...
            # 启动接收任务
            task = asyncio.create_task(self._handle_socket(socket_name, socket, "kline"))
    ...
    async def subscribe_depth(self, symbol: str, depth: str = "20") -> str:
        ...
        try:
            ...
            # 启动接收任务
            task = asyncio.create_task(self._handle_socket(socket_name, socket, "depth"))
    ...
    async def subscribe_trade(self, symbol: str) -> str:
        ...
        try:
            ...
            # 启动接收任务
            task = asyncio.create_task(self._handle_socket(socket_name, socket, "trade"))
    ...
    async def subscribe_ticker(self, symbol: str) -> str:
        ...
        try:
            ...
            # 启动接收任务
            task = asyncio.create_task(self._handle_socket(socket_name, socket, "ticker"))
    ...
    async def subscribe_user_data(self) -> str:
        ...
        if not self.config.api_key:
            msg = "API Key required for user data stream"
            raise BinanceWebSocketError(msg)
        ...
        try:
            ...
            # 启动接收任务
            task = asyncio.create_task(self._handle_user_socket(socket_name, socket))
