...
def get_system_config(db: Session, config_key: str) -> models.SystemConfig | None:
    """获取单个系统配置
...
def get_system_configs(db: Session, skip: int = 0, limit: int = 100) -> list[models.SystemConfig]:
    """获取系统配置列表
...
def create_system_config(db: Session, config: schemas.SystemConfigCreate) -> models.SystemConfig:
    """创建系统配置
...
def update_system_config(
    db: Session, config_key: str, config: schemas.SystemConfigUpdate
) -> models.SystemConfig | None:
    """更新系统配置
...
def get_feature(db: Session, feature_id: int) -> models.Feature | None:
    """获取单个特征
...
def get_features_by_symbol(db: Session, symbol: str) -> list[models.Feature]:
    """根据货币名称获取特征列表
...
def create_features(db: Session, features: list[schemas.FeatureCreate]) -> list[models.Feature]:
    """批量创建特征
...
def update_feature(db: Session, feature_id: int, feature: schemas.FeatureUpdate) -> models.Feature | None:
    """更新特征
...
def delete_features_by_symbol(db: Session, symbol: str) -> bool:
    """根据货币名称删除特征
