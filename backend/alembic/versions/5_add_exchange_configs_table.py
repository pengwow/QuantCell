...
revision: str = "5"
down_revision: str | Sequence[str] | None = "4"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_exchange_configs_exchange_id"),
        "exchange_configs",
        ["exchange_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_exchange_configs_is_default"),
        "exchange_configs",
        ["is_default"],
        unique=False,
    )
    op.create_index(
        op.f("ix_exchange_configs_is_enabled"),
        "exchange_configs",
        ["is_enabled"],
        unique=False,
    )
    op.create_index(
        "idx_exchange_configs_exchange_enabled",
        "exchange_configs",
        ["exchange_id", "is_enabled"],
        unique=False,
    )
